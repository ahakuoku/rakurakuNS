...
# ダウンロード
ダウンロードはこちらから行えます。**(2023年12月31日　v1.4.1に更新)**  
...
**（1.4.1以降）** Simutrans world monitorとの連携機能において、オートセーブ予告を行うかどうかを指定します。  
`1`にすると行います。（1.4.0以前の動作）非常にbotがうるさくなりますのでこの設定を有効にすることは推奨しません。
